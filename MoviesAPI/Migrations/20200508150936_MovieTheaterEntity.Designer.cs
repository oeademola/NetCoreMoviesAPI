...
namespace MoviesAPI.Migrations
{
    ...
    [Migration("20200508150936_MovieTheaterEntity")]
            ...
            modelBuilder.Entity("MoviesAPI.Entities.MovieTheater", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (3.3154061 6.8294238)"),
                            Name = "SilverBird Cinema"
                        },
                        new
                        {
                            Id = 2,
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (3.5069803 6.4375493)"),
                            Name = "Lekki Film House"
                        },
                        new
                        {
                            Id = 3,
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (3.3393472 6.5062713)"),
                            Name = "Ozone Cinema"
                        },
                        new
                        {
                            Id = 4,
                            Location = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-7.4792365 53.5731389)"),
                            Name = "CineWorld"
                        });
                });
